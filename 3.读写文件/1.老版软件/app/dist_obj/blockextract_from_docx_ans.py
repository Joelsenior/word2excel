...
from judge_ans import judge_block
from single_choice_ans import single_choice_block
from multi_choice_ans import multi_choice_block
def extract_block(path_name):
    ...
    for i,line in enumerate(lines):
        ...
        if start_flag_1 in line:
            ...
            result2 += single_choice_block(lines[i+1:])  #当一个文档中有多个选择题，那么就需要用“+=”
            print('\n单选题:',result2)
